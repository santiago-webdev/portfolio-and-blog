...
function J(t) {
	...
	for (let l = 0; l < n.length; l++) {
		const u = n[l].claim_order,
			a = (r > 0 && n[e[r]].claim_order <= u ? r + 1 : W(1, r, (y) => n[e[y]].claim_order, u)) - 1;
		i[l] = e[a] + 1;
		const f = a + 1;
...
function at(t, n, e) {
	w && !e ? K(t, n) : (n.parentNode !== t || n.nextSibling != e) && t.insertBefore(n, e || null);
}
function Q(t) {
...
function z() {
	...
	do {
		...
		for (h(null), d.length = 0, g = 0; T.length; ) T.pop()();
...
function rt(t, n) {
	t.$$.dirty[0] === -1 && (d.push(t), q(), t.$$.dirty.fill(0)),
...
function Ct(t, n, e, i, r, s, c, o = [-1]) {
	...
	if (
		...
		n.intro && nt(t.$$.fragment), et(t, n.target, n.anchor, n.customElement), R(), z();
	}
	h(l);
}
class Tt {
