...
<main>
	<header>
		<hgroup>
			...
			<p>
				You can follow my journey from <a class="internal-link" href="{base}/blog">the blog</a>,
				where I'm trying to compile all of my knowledge to become an all-rounder web developer.
			</p>
		</hgroup>
