  ...
  <section>
    ...
    <article>
      <figure>
        <figcaption>
          ...
          <a href={link.toString()} target="_blank" rel="external" title="Link to live site of this project">{link}</a>
        </figcaption>
    ...
    <article>
      <a id="new-project" href="{base}/#contact">
        Add a new project <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24">
