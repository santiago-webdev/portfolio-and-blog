	...
	<section>
		<div>
			...
			<p>
				...
				<strong>UI/UX</strong> and <strong>Linux</strong>. I believe that technology should be
				accessible to everyone that's why I'm always in the lookout to include every bit of my life
				experiences into my projects.
			</p>
		</div>
