...
function setThemeClass() {
  if (theme === 'light' || theme === 'system-light') {
    ...
    document.documentElement.classList.remove('dark'); // Add the class based on the stored theme
  } else {
    document.documentElement.classList.add('dark'); // Add the class based on the stored theme
